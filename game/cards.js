...
const CardDB = {
    creatures: [
        ...
        { id: 'scribe_solitaire', name: 'Scribe solitaire', atk: 0, riposte: 1, hp: 1, cost: 1, type: 'creature', abilities: [], combatType: 'melee', creatureType: 'parasite', faction: 'black', edition: 1, image: 'black/scribe_solitaire.png', arenaStyle: true, onDeath: { drawCards: 1 }, description: 'Mort : Piochez une carte.' },
