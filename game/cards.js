...
const CardDB = {
    creatures: [
        ...
        {
            id: 'demon_superieur', name: 'Démon supérieur', atk: 3, riposte: 3, hp: 3, cost: 3, type: 'creature',
        ...
        { id: 'assassin_cour', name: 'Assassin de la cour', atk: 3, riposte: 0, hp: 3, cost: 2, type: 'creature', abilities: ['camouflage', 'lethal'], combatType: 'melee', creatureType: 'human', faction: 'black', edition: 4, image: 'black/assassin_de_la_cour.png', arenaStyle: true },
        ...
        { id: 'zombie_delabre', name: 'Zombie délabré', atk: 2, riposte: 1, hp: 3, cost: 3, type: 'creature', abilities: ['poison'], poisonX: 1, combatType: 'melee', creatureType: 'undead', faction: 'black', edition: 1, rarity: 1, image: 'black/zombie_delabre.png', arenaStyle: true, onDeath: { poisonRow: 1 }, description: 'Mort : inflige 1 compteur poison à chaque créature sur la ligne.' },
        ...
        },
        {
            ...
            edition: 2,
            rarity: 2,
            enemyPoisonedRiposteDebuff: 2,
            description: 'Les créatures ennemies avec un marqueur poison ou plus ont -2 DEF.'
        },
        {
        ...
        { id: 'luciole_bicolore', name: 'Luciole bicolore', atk: 1, riposte: 1, hp: 1, cost: 1, type: 'creature', abilities: ['fly', 'soinToxique'], combatType: 'fly', creatureType: 'insect', faction: 'black', edition: 3, rarity: 3, image: 'black/luciole_bicolore.png', arenaStyle: true, buffOnAnyPoisonDeath: true, description: 'Quand une créature meurt du poison, gagne 1 marqueur renforcement.' },
        ...
        { id: 'zobombie', name: 'Zobombie', atk: 1, riposte: 0, hp: 1, cost: 1, type: 'creature', abilities: ['haste'], combatType: 'melee', creatureType: 'undead', faction: 'black', edition: 1, image: 'black/zobombie.png', arenaStyle: true, onDeath: { poisonAdjacent: 1 }, description: 'Mort : Inflige 1 marqueur poison aux créatures adjacentes.' },
        ...
        { id: 'rosalia_demonicus', name: 'Rosalia démonicus', hp: 3, cost: 2, type: 'creature', isBuilding: true, abilities: [], faction: 'black', edition: 2, image: 'black/rosalia_demonicus.png', arenaStyle: true, activeAbility: 'poisonAll', description: 'Activation : Placez 1 marqueur poison sur chaque créature du champs de bataille.' },
        { id: 'mausole_sinistre', name: 'Mausolée sinistre', hp: 3, cost: 2, type: 'creature', isBuilding: true, abilities: [], faction: 'black', edition: 2, image: 'black/mausole_sinistre.png', arenaStyle: true, activeAbility: 'discardHighestDrawCreature', description: 'Activation : Défaussez la créature avec le coût le plus élevé de votre main. Si vous vous êtes défaussé d\'une carte de cette façon, piochez une carte.' },
        ...
        { id: 'scribe_solitaire', name: 'Scribe solitaire', atk: 1, riposte: 0, hp: 1, cost: 1, type: 'creature', abilities: [], combatType: 'melee', creatureType: 'undead', faction: 'black', edition: 1, image: 'black/scribe_solitaire.png', arenaStyle: true, onDeath: { drawCards: 1 }, description: 'Mort : Piochez une carte.' },
    ...
    spells: [
        ...
        { id: 'tri_selectif', name: 'Tri sélectif', cost: 2, type: 'spell', spellSpeed: 4, offensive: false, spellType: 'défensif', pattern: 'hero', targetSelf: true, effect: 'triSelectif', image: 'black/tri_selectif.png', arenaStyle: true, faction: 'black', edition: 2, rarity: 2, description: 'Piochez 5 cartes. Les créatures, bâtiments et pièges vont au cimetière. Perdez 2 PV par carte mise dans votre main.' },
        ...
        { id: 'contamination_eau', name: 'Contamination de l\'eau', cost: 2, type: 'spell', spellSpeed: 3, offensive: true, spellType: 'offensif', pattern: 'all', effect: 'poisonAllCreatures', poisonAmount: 1, image: 'black/contamination_de_leau.png', arenaStyle: true, faction: 'black', edition: 3, description: 'Toutes les créatures reçoivent un marqueur poison.' },
        { id: 'envenimement', name: 'Envenimement', cost: 1, type: 'spell', spellSpeed: 1, offensive: true, spellType: 'offensif', pattern: 'single', targetAnyCreature: true, effect: 'doublePoisonTarget', image: 'black/envenimement.png', arenaStyle: true, faction: 'black', edition: 2, rarity: 2, description: 'Doublez le nombre de marqueurs poison sur la créature ciblée.' },
        ...
        { id: 'brume_toxique', name: 'Brume toxique', cost: 2, type: 'spell', spellSpeed: 2, offensive: true, spellType: 'offensif', pattern: 'all', effect: 'triggerPoisonEnemies', image: 'black/brume_toxique.png', arenaStyle: true, faction: 'black', edition: 1, rarity: 1, description: 'Chaque créature ennemie empoisonnée subit immédiatement ses dégâts de poison.' },
        ...
        { id: 'purger_par_effroi', name: 'Purger par effroi', cost: 3, type: 'spell', spellSpeed: 2, offensive: true, spellType: 'offensif', pattern: 'single', targetAnySlot: true, effect: 'poisonTarget', poisonAmount: 5, image: 'black/purger_par_effroi.png', arenaStyle: true, faction: 'black', edition: 2, rarity: 2, description: 'Met 5 marqueurs poison sur la créature ciblée.' },
        { id: 'justice_perverse', name: 'Justice perverse', cost: 6, type: 'spell', spellSpeed: 1, offensive: true, spellType: 'offensif', pattern: 'all', effect: 'sacrificeHighestAtkEnemy', image: 'black/justice_perverse.png', arenaStyle: true, faction: 'black', edition: 2, rarity: 2, description: 'L\'adversaire sacrifie sa créature avec l\'attaque la plus haute.' },
...
for (const creature of CardDB.creatures) {
    ...
    creature.riposte = creature.isBuilding ? 0 : (Number.isFinite(rawRiposte) ? Math.max(0, Math.floor(rawRiposte)) : 2);
}
...
function resetCardForGraveyard(card) {
    ...
    if (reset.type === 'creature') {
        ...
        reset.riposte = reset.isBuilding ? 0 : (Number.isFinite(rawRiposte) ? Math.max(0, Math.floor(rawRiposte)) : 2);
...
function createDeck() {
    ...
    for (let i = 0; i < 40; i++) {
        ...
        if (card.type === 'creature') {
            ...
            card.riposte = card.isBuilding ? 0 : (Number.isFinite(rawRiposte) ? Math.max(0, Math.floor(rawRiposte)) : 2);
...
const ABILITY_RESOLUTION_CONTRACT = Object.freeze({
    commonAbilities: Object.freeze({
        ...
        trepas: 'summon conditional buff',
    ...
    creatureHooks: Object.freeze({
        ...
        selfPoisonOnSummon: 'summon self-poison',
        trepasBuffCounters: 'summon conditional buff'
    }),
    onDeathKeys: Object.freeze({
        damageHero: 'death handling',
        damageKiller: 'death handling',
        discardHandAndRedraw: 'death handling',
    ...
    activeAbilityKeys: Object.freeze({
        discardHighestDrawCreature: 'building active ability',
    ...
    spellEffectKeys: Object.freeze({
        ...
        doublePoisonTarget: 'spell resolution',
        ...
        poisonAllCreatures: 'spell resolution',
        poisonAllEnemies: 'spell resolution',
        reanimate: 'spell resolution',
        reanimateBloodPact: 'spell resolution',
        ...
        triggerPoisonEnemies: 'spell resolution'
    }),
